    ...
    return (
        <main className="min-h-screen bg-neutral-950 text-white">
            ...
            >
                ...
                {loading && (
                    <div
                        className="mb-6 rounded-xl border border-neutral-800 bg-neutral-900/40 px-4 py-3 text-sm text-neutral-400">
                ...
                {error && (
                    <div
                        className="mb-6 rounded-xl border border-red-900/60 bg-red-950/20 px-4 py-3 text-sm text-red-300">
                    ...
                    >
                        <div className="overflow-hidden rounded-xl border border-neutral-800 bg-black/20">
                            ...
                            <div className="grid min-h-[420px] lg:grid-cols-[minmax(260px,0.8fr)_minmax(0,1.6fr)]">
                                <div
                                    className="max-h-[420px] overflow-y-auto border-b border-neutral-800 lg:border-b-0 lg:border-r">
                                    {rawEvents.length === 0 ? (
                                ...
                                <div className="max-h-[420px] overflow-auto p-5">
                                    {selectedRawEvent ? (
                                        <pre
                                            className="whitespace-pre-wrap break-words font-mono text-xs leading-6 text-neutral-300">
                {JSON.stringify(
                    selectedRawEvent,
                    null,
                    2
